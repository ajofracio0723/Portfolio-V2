...
const CONTACT_INBOX =
  import.meta.env.VITE_CONTACT_EMAIL || "abejayofracio@gmail.com";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        }<br/><br/><span style="opacity:.85;font-size:13px">You can also email me directly at <a href="mailto:${CONTACT_INBOX}?subject=${encodeURIComponent(
          "Portfolio inquiry"
        )}" style="color:#818cf8">${CONTACT_INBOX}</a></span>`,
        icon: "error",
        ...swalDark,
      });
    } finally {
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%] ">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Have a question? Send me a message, and I'll reply as soon as possible.
        </p>
      </div>
